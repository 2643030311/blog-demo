...
**该篇幅自己收录，用于自己的学习。来自阮一峰老师的博客，地址[Flex 布局教程：语法篇 - 阮一峰的网络日志 (ruanyifeng.com)](https://www.ruanyifeng.com/blog/2015/07/flex-grammar.html)**
...
Flex 是 Flexible Box 的缩写，意思为“弹性布局”，用来为盒状模型提供最大的灵活性。
